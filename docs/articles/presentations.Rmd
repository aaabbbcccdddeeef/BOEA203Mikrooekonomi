...
**Øvelse budsjettlinjen**

Anta at du har en inntekt på 40 NOK som brukes på to goder. Gode 1 koster 10m- per enhet, og gode 2 koster 5,- per enhet.
...
- *Gossen’s lov*: Nyttetilskuddet av den siste krona brukt på det ene godet, skal være lik Nyttetilskuddet av den siste krona brukt på det andre godet.
...
**Øvelse om konsumentens optimale tilpasning**

Benytt opplysningene fra de to foregående øvelsene (øvelse om MSB og budsjettlinjen), og skriv ned toto første ordens betingelsnee for konsumentens optimale tilpasnin. Illustrer så tilpasningen grafisk ved bruk av et diagram.
