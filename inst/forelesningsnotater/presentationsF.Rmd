...
### Tilbudsfunksjonen etter arbeid (ikke pensum, for de spesielt intereserte)
...
```{r, echo=FALSE, out.width="30%", fig.cap=""}
mp102 <- paste0(rprojroot::find_rstudio_root_file(),'/inst/forelesningsnotater/drawio/10.2_mp.png')
