...
## Appendiks (figurer benyttet under forelesning)
...
```{r, echo=FALSE, out.width="45%", fig.cap=""}
p1 <- paste0(rprojroot::find_rstudio_root_file(),'/inst/forelesningsnotater/drawio/drawio/oversikt_prod_iii.drawio.png')
```
