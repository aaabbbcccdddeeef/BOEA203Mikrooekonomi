...
pathn <- '/inst/forelesningsnotater/presentationsD'
...
.pull-left[
Kostnader uten faste kostnader
...
```{r, echo=FALSE, out.width="50%", fig.cap=""}
kosminkl <- paste0(rprojroot::find_rstudio_root_file(),'/inst/forelesningsnotater/drawio/kosminkl.png')
knitr::include_graphics(fss)
```
]
...
.pull-left[
```{r, echo=FALSE, out.width="50%", fig.cap=""}
ktilbu <- paste0(rprojroot::find_rstudio_root_file(),'/inst/forelesningsnotater/drawio/ktilbu.png')
knitr::include_graphics(ktilbu)
```
]
